    ...
    def setup_stage(self, stage, dataloader=None):
        if stage == 0:
            ...
            if stage > self.start_stage:
                ...
                self.target_G2[:,stage-2] = 1
                self.optimizerD = self.initialize_optimizer(self.modelD[0], lr=self.lr_dis*np.exp(-stage+1), optim_method=self.optim_method, weight_decay=0.01*self.lr_dis)
    ...
    def train(self, stage, epoch, dataloader):
        ...
        ################################################
            ...
            while i < self.len_dataset:
                ...
                acc_G1 = 100*self.logits_eval(out_G1, self.target_G1[:batch_size])

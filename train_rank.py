    ...
    def train(self, stage, epoch, dataloader):
        ...
        ################################################
            ...
            while i < self.len_dataset:
                ...
                acc_real = self.logits_eval(logits_D, self.target_real[:batch_size])
                ...
                acc_G1 = self.logits_eval(out_G1, self.target_G1[:batch_size])
            ...
            while i < self.len_dataset:
                ...
                while j < d_iterations and i < self.len_dataset:
                    ...
                    acc_G2 = self.logits_eval(out_G2, self.target_G2[:batch_size])
                ...
                while j < self.g_iter and i < self.len_dataset:
                    ...
                    logits_G2 = self.sigmoid(out_G2)
                    acc_G2 = self.logits_eval(out_G2, self.target_real[:batch_size])

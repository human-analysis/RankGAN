...
class Trainer():
    def __init__(self, args, modelD, modelG, Encoder, criterion, prevD, prevG):
        ...
        self.weight_vae = args.weight_vae
    ...
    def setup_stage(self, stage, dataloader=None):
        if stage == 1:
            ...
            self.lr_dis = self.lr_dis*0.5
            self.lr_gen = self.lr_gen*0.5
    ...
    def train(self, stage, epoch, dataloader):
        ...
        ############################
            ...
            while i < self.len_dataset:
                ...
                loss_mse = self.criterion.diff_loss(fake_G0, input, type=self.vae_loss_type)
                ...
                losses_train['Loss_G0'] = loss_mse.item()
                ...
                print('Stage %d: [%d/%d][%d/%d] Loss_MSE: %.3f Loss_KLD: %.3f Score_D0: %.3f Score_D0_G0: %.3f Disc_Acc %.3f GP %.3f'
                % (stage, epoch, self.stage_epochs[stage], i, self.len_dataset, loss_mse.item(), loss_kld.item(), 0, 0, 0, 0))
            ...
            while i < self.len_dataset:
                ...
                while j < d_iterations and i < self.len_dataset:
                    ...
                    if j < d_iterations:
                        ...
                        % (stage, epoch, self.stage_epochs[stage], i, self.len_dataset, lossD, 0, mean_scores_D0, mean_scores_D0_G0, disc_acc, gradient_penalty.item()))

...
class netOpenFace(nn.Module):
    def __init__(self, args, gpuDevice=0):
        ...
        self.layer14 = Inception(192, (3,5), (1,1), (128,32), (96,16,32,64), nn.MaxPool2d((3,3), stride=(1,1), padding=(1,1)), True)

        # Inception (3b)
        # self.layer15 = Inception(256, (3,5), (1,1), (128,64), (96,32,64,64), nn.LPPool2d(2, (3,3), stride=(3,3)), True)
        self.layer15 = Inception(256, (3,5), (1,1), (128,64), (96,32,64,64), nn.LPPool2d(2, (3,3), stride=(1,1)), True)

        # Inception (3c)
        # self.layer16 = Inception(320, (3,5), (2,2), (256,64), (128,32,None,None), nn.MaxPool2d((3,3), stride=(2,2), padding=(0,0)), True)
        self.layer16 = Inception(320, (3,5), (2,2), (256,64), (128,32,None,None), nn.MaxPool2d((3,3), stride=(2,2), padding=(1,1)), True)

        # Inception (4a)
        # self.layer17 = Inception(640, (3,5), (1,1), (192,64), (96,32,128,256), nn.LPPool2d(2, (3,3), stride=(3,3)), True)
        self.layer17 = Inception(640, (3,5), (1,1), (192,64), (96,32,128,256), nn.LPPool2d(2, (3,3), stride=(1,1)), True)

        # Inception (4e)
        # self.layer18 = Inception(640, (3,5), (2,2), (256,128), (160,64,None,None), nn.MaxPool2d((3,3), stride=(2,2), padding=(0,0)), True)
        self.layer18 = Inception(640, (3,5), (2,2), (256,128), (160,64,None,None), nn.MaxPool2d((3,3), stride=(2,2), padding=(1,1)), True)

        # Inception (5a)
        # self.layer19 = Inception(1024, (3,), (1,), (384,), (96,96,256), nn.LPPool2d(2, (3,3), stride=(3,3)), True)
        self.layer19 = Inception(1024, (3,), (1,), (384,), (96,96,256), nn.LPPool2d(2, (3,3), stride=(1,1)), True)

        # Inception (5b)
        # self.layer21 = Inception(736, (3,), (1,), (384,), (96,96,256), nn.MaxPool2d((3,3), stride=(2,2), padding=(0,0)), True)
        self.layer21 = Inception(736, (3,), (1,), (384,), (96,96,256), nn.MaxPool2d((3,3), stride=(1,1), padding=(1,1)), True)
    ...
    def forward(self, input):
        ...
        x = self.layer3(self.layer2(self.layer1(x))) # 1
        x = self.layer5(self.layer4(x))              # 2
        x = self.layer11(self.layer10(self.layer9(self.layer8(self.layer7(self.layer6(x))))))    # Inception 2
        x = self.layer13(self.layer12(x))
        ...
        x = self.layer14(x)     # Inception (3a)
        x = self.layer15(x)     # Inception (3b)
        x = self.layer16(x)     # Inception (3c)
        x = self.layer17(x)     # Inception (4a)
        x = self.layer18(x)     # Inception (4e)
        x = self.layer19(x)     # Inception (5a)
        x = self.layer21(x)     # Inception (5b)
        x = self.layer22(x)     # AvgPool
        x = x.view((-1, 736))
